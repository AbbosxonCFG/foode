...
def table(request):
    if request.method == 'POST':
        ...
        table.generate_qr(f'{request.get_host()}/client/{table.id}')
...
def stol(request):
    ...
    return render(request,'dashboard_cart.html',{'stols':stols})
...
def cart(request,pk):
    ...
    return render(request,"detail_cart.html",contex)
